...
function CarouselItem({ id, userImg, name, testimonial, isActive, currentItem, onDotClick }) {
  ...
  return (
    <section 
      key={id} 
      className={`px-5 pt-12 ${isActive ? 'sm:block' : 'sm:hidden lg:block'} md:mt-24 md:mx-10 
        md:rounded-sm lg:px-0 lg:m-0
      `}
    >
      <div className='bg-veryLightGray rounded gap-5 pb-10 flex flex-col items-center md:pb-14 
        md:gap-10 lg:gap-6 lg:p-5 lg:m-0 lg:w-[500px] lg:h-[220px]
        '
      >
        ...
        <p className='text-lg text-center text-darkGrayishBlue leading-loose px-6 md:text-2xl 
          md:px-20 md:leading-relaxed lg:p-0 lg:text-base'>{testimonial}</p>
      </div>
